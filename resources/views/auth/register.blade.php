    ...
    <div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full mx-auto">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                        class="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 transition duration-200"
            ...
            <div class="flex items-center">
                <input type="checkbox" name="terms" id="terms" required class="rounded text-blue-600 focus:ring-blue-500 border-gray-300">
        ...
        <div class="mt-6 text-center">
            <a href="/" class="group inline-flex items-center transition-all duration-300 text-gray-600 hover:text-blue-600">
